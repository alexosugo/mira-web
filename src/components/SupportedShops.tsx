...
const SupportedShops = () => {
  return (
    <section id="supported-shops" className="py-3 sm:py-4 lg:py-5">
      <div className="px-6 sm:px-8 lg:px-10">
        <div className="rounded-xl bg-cobalt px-5 py-16 text-white sm:rounded-2xl sm:px-8 sm:py-20 lg:px-16 lg:py-24">
