...
Secondary audience: SME owners in adjacent channels (WhatsApp, Facebook) who may join as Sellogram's channel coverage grows. The site speaks to the Instagram seller first.

## Product Purpose

Sellogram answers a shop's Instagram DMs and sells in them. It handles questions about pricing, stock, sizes, and delivery, builds a cart, and takes the customer through to checkout, all inside the DM thread. Tricky conversations get handed to the owner. Success looks like: a shop owner wakes up to completed orders, not a backlog of unanswered messages.
...
- Zero jargon. Never "AI-powered", "machine learning", "automation engine". Say what Sellogram does: answers, replies, builds a cart, hands over.
...
- Light situational humor ("Your DMs at 2am? Sellogram's got it."). No exclamation points.
...
- **Cheap template look**: default Bootstrap/ThemeForest patterns. Sellogram asks owners to hand over their DMs; the site must look like it deserves that trust.
...
2. **Show what Sellogram does, never what powers it.** Demonstrations over claims. A chat transcript answering a size question beats any "intelligent" adjective.
