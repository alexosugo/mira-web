...
> Same as PHOTO but night scene. Deep green-black base (#131E09, #1D2C0E). Single warm lamp or phone glow in mint (#B5F27C) and soft gold (#F0B254). Quiet, calm, safe. No blue neon, no harsh white light.
...
| 2 | Hero, alternate | PHOTO | 4:5 | Close crop of two hands holding a smartphone over a table of sneakers and skincare bottles. The screen is plain matte dark green (#131E09), blank, ready for an overlay. Amber price tags on the products. |
...
| 16 | Pricing and footer background texture | SPOT | 21:9 | Abstract paper texture, pale sage, faint hairline grid in #DEE6D7, very low contrast, nothing else. |
