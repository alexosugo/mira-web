...
Marketing landing page for Sellogram: answers a shop's Instagram DMs and sells in them (Kenyan Instagram sellers, waitlist conversion). Vite + React 18 + TypeScript + Tailwind, deployed on Netlify.
...
- **`brand/foundations.md`**: the approved visual foundations already used by the website: palette, typography, shape language, and motion.
- **`docs/voice-and-tone.md`**: voice rules. No jargon, no "AI-powered", no exclamation points; say what Sellogram does.
