...
Warm, capable, grounded, calm, specific and honest. Like an experienced shop
assistant — not a technology company, a motivational speaker, or an
overfamiliar social-media manager.

- **Clear** — state the answer early, ordinary words, direct verbs.
- **Familiar** — price, available, in stock, size, colour, delivery, pickup,
  order, payment, reply, DMs. No forced slang.
- **Helpful** — explain what happens next, don't just announce features.
- **Calm** — never manufacture urgency or make the owner feel behind.
- **Specific** — product behaviour as proof ("price, stock, size, colour,
  delivery and pickup questions"), never "every customer enquiry".
- **Honest** — qualified language where conditions apply. "You confirm the
...
Contractions where natural. Sentence case for headings and buttons. No
exclamation marks. No three-part fragment slogans ("Faster. Smarter. Better.").
...
- **Corporate**: streamline, optimise, leverage, utilise, facilitate, scale
  ...
  efficiency, "steady DM traffic", "carrying real DM volume".
- **Hype**: innovative, revolutionary, game-changing, magic, effortless,
...
outcomes or customer endorsements; guarantees a sale; replaces all
customer-service work. Do not use "unlimited conversations" until fair-use
rules are confirmed.
...
Show the product. All current site conversations are illustrative — label a
group of examples once ("Example conversations based on questions Instagram
shops commonly receive."), never invent shop names, quotes, metrics, logos or
outcomes presented as real.

## Local language

KES, M-Pesa, pickup and delivery appear where they genuinely belong to the
buying process. No "Sasa", neighbourhood name-drops, or slang added to prove
localness.
